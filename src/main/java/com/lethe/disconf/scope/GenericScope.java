...
public class GenericScope implements Scope, BeanFactoryPostProcessor,
     ...
     */
    public void setScopeCache(StandardScopeCache cache) {
    ...
    public void destroy() {
        ...
        // 缓存清空，其底层是个Map，在调用其get(String name, ObjectFactory<?> objectFactory)时，会加入
    ...
    private void setSerializationId(ConfigurableListableBeanFactory beanFactory) {
        ...
        if (beanFactory instanceof DefaultListableBeanFactory) {
            ...
            logger.warn("BeanFactory was not a DefaultListableBeanFactory, scoped proxy beans "
    ...
    private static class BeanLifecycleWrapperCache {
        ...
        private final StandardScopeCache cache;

        BeanLifecycleWrapperCache(StandardScopeCache cache) {
            this.cache = cache;
        }
